...
## Step 3:
    - Run the terraform configuration
        ...
        - Run the following commands
            - "ssh-keygen -t rsa -b 4096 -f aws-terraform"   before "terraform validation" we have to put this command in the terminal"
            - "terraform init"
            - "terraform validate"
            - "terraform plan"
            - "terraform apply" 
...
## Step 4:
    - Connect to the EC2-instance
        ...
        - Run "ssh -i terraformkey ubuntu@<PUBLIC_IP>"
